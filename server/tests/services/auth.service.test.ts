...
import { InvalidCredentialsError, login } from '../../src/services/auth.service';
...
describe('login service', () => {
  ...
  it('issues a valid JWT for correct credentials', async () => {
    ...
    const decoded = jwt.verify(result.accessToken, process.env.JWT_ACCESS_SECRET!) as jwt.JwtPayload;
